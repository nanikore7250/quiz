import { saveCatalogMeta, loadCatalogMeta, saveQuizSet, loadQuizSet, getLocalVersion, } from './db';
...
async function downloadQuizSet(meta) {
...
export async function isSetAvailable(id) {
